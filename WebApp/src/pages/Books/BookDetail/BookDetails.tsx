...
function BookDetails() {
  ...
  return (
    <>
            ...
            <div className="flex-auto p-4 text-xl">
              <div className="mb-2 flex flex-row">
                <div className="flex w-[30%] flex-row break-words pr-8 font-bold">
                  ...
                  <span className="pl-2 font-light text-zinc-700">Rating</span>
                </div>
                <div className="break-words font-bold text-purple-500">
                  {data?.data.rateAvarage! > 0
                    ? +data?.data.rateAvarage.toFixed(2)! + "/5"
                    : "-/5"}
                </div>
              </div>
              <div className="mb-2 flex flex-row">
      ...
      <BookComment bookId={bookId} refetchBook={refetchBook} />
    </>
  );
}
